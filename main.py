...
def createEmoticon(update, context):
    ...
    context.bot.create_new_sticker_set(user_id=318996831, name="test_sticker", title="Test Sticker", emojis="😀", contains_masks=False, png_sticker=open("emoticonTemp/0.png", "rb"))
